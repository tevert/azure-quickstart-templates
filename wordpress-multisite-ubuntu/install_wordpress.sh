...
sudo wp core multisite-install --url="$serverUrl" --title="$siteName" --admin_user="$1" --admin_password="$2" --admin_email="$1@example.com" --skip-email --path=/var/www/html/wordpress --base=/wordpress --allow-root
